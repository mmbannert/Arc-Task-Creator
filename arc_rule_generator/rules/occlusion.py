...
from arc_rule_generator.config import COLORS, GRID_SIZE
from arc_rule_generator.rules._common import make_params, make_grids
...
def generate_occlusion_mirror_y(size_range=(2, 5)):
    grid_input, _, _ = generate_occlusion_reversal(size_range=size_range)
...
def generate_occlusion_rotate_90(size_range=(2, 5)):
    grid_input, _, _ = generate_occlusion_reversal(size_range=size_range)
...
def generate_occlusion_rotate_180(size_range=(2, 5)):
    grid_input, _, _ = generate_occlusion_reversal(size_range=size_range)
...
def generate_occlusion_reversal(size_range=(2, 5)):
